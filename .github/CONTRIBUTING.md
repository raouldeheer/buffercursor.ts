...
A big welcome and thank you for considering contributing to buffercursor.ts.
...
We take the open source community seriously and hold ourselves and other contributors to high standards of communication. By participating and contributing to this project, you agree to uphold our [Code of Conduct](https://github.com/raouldeheer/buffercursor.ts/blob/main/.github/CODE_OF_CONDUCT.md).

## Getting Started

Contributions are made to this repo via Issues and Pull Requests (PRs). A few general guidelines that cover both:

- To report security vulnerabilities, please follow our [security policy](https://github.com/raouldeheer/buffercursor.ts/security/policy).
